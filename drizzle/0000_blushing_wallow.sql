...
ALTER TABLE "project_booking_codes" ADD CONSTRAINT "project_booking_codes_booking_code_group_id_booking_code_groups" FOREIGN KEY ("booking_code_group_id") REFERENCES "public"."booking_code_groups"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "software_whitelist_versions" ADD CONSTRAINT "software_whitelist_versions_software_whitelist_id_software_whit" FOREIGN KEY ("software_whitelist_id") REFERENCES "public"."software_whitelist"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "server_groups_ownerId_idx" ON "server_groups" USING btree ("ownerId" text_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "unique_server_group_name_idx" ON "server_groups" USING btree ("name" text_ops);--> statement-breakpoint
CREATE INDEX "os_patch_versions_osId_idx" ON "os_patch_versions" USING btree ("osId" int4_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "unique_location_name_idx" ON "locations" USING btree ("name" text_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "unique_os_name_idx" ON "os" USING btree ("name" text_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "unique_project_drawing_idx" ON "project_drawings" USING btree ("project_id" int4_ops,"drawing_id" int4_ops);--> statement-breakpoint
CREATE INDEX "drawings_name_idx" ON "drawings" USING btree ("name" text_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "unique_user_project_idx" ON "primary_project_engineers" USING btree ("userId" int4_ops,"project_id" int4_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "unique_project_link_server_idx" ON "project_link_servers" USING btree ("project_link_id" int4_ops,"server_id" int4_ops);--> statement-breakpoint
CREATE INDEX "project_links_name_idx" ON "project_links" USING btree ("name" text_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "unique_project_link_idx" ON "project_links" USING btree ("project_id" int4_ops,"link" text_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "unique_project_link_name_idx" ON "project_links" USING btree ("project_id" int4_ops,"name" int4_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "unique_application_name_idx" ON "applications" USING btree ("name" text_ops);--> statement-breakpoint
CREATE INDEX "applications_servers_applicationId_idx" ON "applications_servers" USING btree ("applicationId" int4_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "unique_user_server_idx" ON "users_servers" USING btree ("userId" int4_ops,"serverId" text_ops);--> statement-breakpoint
CREATE INDEX "users_servers_serverId_idx" ON "users_servers" USING btree ("serverId" int4_ops);--> statement-breakpoint
CREATE INDEX "users_servers_userId_idx" ON "users_servers" USING btree ("userId" text_ops);--> statement-breakpoint
CREATE INDEX "post_serverId_idx" ON "posts" USING btree ("serverId" int4_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "unique_post_slug_idx" ON "posts" USING btree ("slug" text_ops);--> statement-breakpoint
CREATE INDEX "servers_tags_serverId_idx" ON "servers_tags" USING btree ("serverId" int4_ops);--> statement-breakpoint
CREATE INDEX "server_business_id_idx" ON "servers" USING btree ("business" int4_ops);--> statement-breakpoint
CREATE INDEX "server_project_id_idx" ON "servers" USING btree ("projectId" int4_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "unique_server_hostname_idx" ON "servers" USING btree ("hostname" text_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "unique_server_ipv4_idx" ON "servers" USING btree ("ipv4" text_ops) WHERE (ipv4 IS NOT NULL);--> statement-breakpoint
CREATE UNIQUE INDEX "unique_server_ipv6_idx" ON "servers" USING btree ("ipv6" text_ops) WHERE (ipv6 IS NOT NULL);--> statement-breakpoint
CREATE UNIQUE INDEX "unique_server_drawing_idx" ON "server_drawings" USING btree ("server_id" int4_ops,"drawing_id" int4_ops);--> statement-breakpoint
CREATE INDEX "server_notes_note_id_idx" ON "server_notes" USING btree ("noteId" int4_ops);--> statement-breakpoint
CREATE INDEX "server_notes_server_id_idx" ON "server_notes" USING btree ("serverId" int4_ops);--> statement-breakpoint
CREATE INDEX "server_id_idx" ON "server_scans" USING btree ("serverId" int4_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "unique_tag_name_idx" ON "tags" USING btree ("name" text_ops);--> statement-breakpoint
CREATE INDEX "server_collection_subscriptions_collectionId_idx" ON "server_collection_subscriptions" USING btree ("collectionId" int4_ops);--> statement-breakpoint
CREATE INDEX "server_collection_subscriptions_userId_idx" ON "server_collection_subscriptions" USING btree ("userId" text_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "unique_user_collection_idx" ON "server_collection_subscriptions" USING btree ("userId" text_ops,"collectionId" int4_ops);--> statement-breakpoint
CREATE INDEX "servers_collections_serverId_idx" ON "servers_collections" USING btree ("serverId" int4_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "unique_server_collection_idx" ON "servers_collections" USING btree ("serverId" int4_ops,"collectionId" int4_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "unique_collection_name_idx" ON "collections" USING btree ("name" text_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "unique_business_name_idx" ON "business" USING btree ("name" text_ops);--> statement-breakpoint
CREATE INDEX "patching_policy_name_idx" ON "patching_policy" USING btree ("name" text_ops);--> statement-breakpoint
CREATE INDEX "patching_policy_responsibility_idx" ON "patching_policy" USING btree ("responsibility" int4_ops);--> statement-breakpoint
CREATE INDEX "expires_at_idx" ON "certs" USING btree ("expires_at" timestamptz_ops);--> statement-breakpoint
CREATE INDEX "request_id_idx" ON "certs" USING btree ("request_id" text_ops);--> statement-breakpoint
CREATE INDEX "requested_by_idx" ON "certs" USING btree ("requested_by_id" text_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "unique_responsibility_name_idx" ON "patching_policy_responsibility" USING btree ("name" text_ops);--> statement-breakpoint
CREATE INDEX "user_id_idx" ON "notes" USING btree ("userId" text_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "unique_project_name_idx" ON "projects" USING btree ("name" text_ops);--> statement-breakpoint
CREATE INDEX "collections_tags_collectionId_idx" ON "collections_tags" USING btree ("collectionId" int4_ops);--> statement-breakpoint
CREATE INDEX "notifications_read_idx" ON "notifications" USING btree ("read" bool_ops);--> statement-breakpoint
CREATE INDEX "notifications_user_id_idx" ON "notifications" USING btree ("userId" text_ops);--> statement-breakpoint
CREATE INDEX "chat_messages_categoryId_idx" ON "chat_messages" USING btree ("categoryId" int4_ops);--> statement-breakpoint
CREATE INDEX "chat_messages_chatRoomId_idx" ON "chat_messages" USING btree ("chatRoomId" text_ops);--> statement-breakpoint
CREATE INDEX "chat_messages_user_id_idx" ON "chat_messages" USING btree ("userId" text_ops);--> statement-breakpoint
CREATE INDEX "chat_categories_enabled_idx" ON "chat_categories" USING btree ("enabled" bool_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "unique_chat_category_name_idx" ON "chat_categories" USING btree ("name" text_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "unique_os_family_name_idx" ON "os_family" USING btree ("name" text_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "unique_booking_code_group_name_idx" ON "booking_code_groups" USING btree ("name" text_ops);--> statement-breakpoint
CREATE INDEX "booking_code_group_id_idx" ON "booking_codes" USING btree ("group_id" int4_ops);--> statement-breakpoint
CREATE INDEX "booking_code_validity_idx" ON "booking_codes" USING btree ("valid_from" timestamptz_ops,"valid_to" timestamptz_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "unique_booking_code_in_timeframe_idx" ON "booking_codes" USING btree ("group_id" timestamptz_ops,"code" int4_ops,"valid_from" int4_ops);--> statement-breakpoint
CREATE INDEX "project_booking_codes_group_id_idx" ON "project_booking_codes" USING btree ("booking_code_group_id" int4_ops);--> statement-breakpoint
CREATE INDEX "project_booking_codes_project_id_idx" ON "project_booking_codes" USING btree ("project_id" int4_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "unique_project_booking_code_group_idx" ON "project_booking_codes" USING btree ("project_id" int4_ops,"booking_code_group_id" int4_ops);--> statement-breakpoint
CREATE INDEX "software_version_whitelist_idx" ON "software_whitelist_versions" USING btree ("software_whitelist_id" int4_ops);--> statement-breakpoint
