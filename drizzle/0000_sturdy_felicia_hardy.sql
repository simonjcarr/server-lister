...
CREATE TABLE "notifications" (
	...
	"delivery_type" text DEFAULT 'browser' NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "sub_task_comments" (
	"id" serial PRIMARY KEY NOT NULL,
...
CREATE TABLE "engineer_hours" (
	"id" serial PRIMARY KEY NOT NULL,
	"server_id" integer NOT NULL,
	"booking_code_id" integer NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "build_doc_section_templates" (
	"id" serial PRIMARY KEY NOT NULL,
	"title" text NOT NULL,
	"content" text,
	"tags" text[],
...
ALTER TABLE "sub_task_comments" ADD CONSTRAINT "sub_task_comments_subTaskId_sub_tasks_id_fk" FOREIGN KEY ("subTaskId") REFERENCES "public"."sub_tasks"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "sub_task_comments" ADD CONSTRAINT "sub_task_comments_userId_user_id_fk" FOREIGN KEY ("userId") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "sub_tasks" ADD CONSTRAINT "sub_tasks_taskId_tasks_id_fk" FOREIGN KEY ("taskId") REFERENCES "public"."tasks"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "sub_tasks" ADD CONSTRAINT "sub_tasks_assignedTo_user_id_fk" FOREIGN KEY ("assignedTo") REFERENCES "public"."user"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "tasks" ADD CONSTRAINT "tasks_serverId_servers_id_fk" FOREIGN KEY ("serverId") REFERENCES "public"."servers"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "engineer_hours" ADD CONSTRAINT "engineer_hours_server_id_servers_id_fk" FOREIGN KEY ("server_id") REFERENCES "public"."servers"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "engineer_hours" ADD CONSTRAINT "engineer_hours_booking_code_id_booking_codes_id_fk" FOREIGN KEY ("booking_code_id") REFERENCES "public"."booking_codes"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "engineer_hours" ADD CONSTRAINT "engineer_hours_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "build_doc_section_templates" ADD CONSTRAINT "build_doc_section_templates_parent_template_id_build_doc_section_templates_id_fk" FOREIGN KEY ("parent_template_id") REFERENCES "public"."build_doc_section_templates"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "build_doc_section_templates" ADD CONSTRAINT "build_doc_section_templates_created_by_user_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "build_doc_section_templates" ADD CONSTRAINT "build_doc_section_templates_updated_by_user_id_fk" FOREIGN KEY ("updated_by") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "build_doc_sections" ADD CONSTRAINT "build_doc_sections_parent_section_id_build_doc_sections_id_fk" FOREIGN KEY ("parent_section_id") REFERENCES "public"."build_doc_sections"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "build_doc_sections" ADD CONSTRAINT "build_doc_sections_created_by_user_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "build_doc_sections" ADD CONSTRAINT "build_doc_sections_updated_by_user_id_fk" FOREIGN KEY ("updated_by") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "build_docs" ADD CONSTRAINT "build_docs_server_id_servers_id_fk" FOREIGN KEY ("server_id") REFERENCES "public"."servers"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "build_docs" ADD CONSTRAINT "build_docs_created_by_user_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "build_docs" ADD CONSTRAINT "build_docs_updated_by_user_id_fk" FOREIGN KEY ("updated_by") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "engineer_hours_server_id_idx" ON "engineer_hours" USING btree ("server_id");--> statement-breakpoint
CREATE INDEX "engineer_hours_booking_code_id_idx" ON "engineer_hours" USING btree ("booking_code_id");--> statement-breakpoint
CREATE INDEX "engineer_hours_user_id_idx" ON "engineer_hours" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "engineer_hours_date_idx" ON "engineer_hours" USING btree ("date");--> statement-breakpoint
CREATE INDEX "build_doc_sections_build_doc_id_idx" ON "build_doc_sections" USING btree ("build_doc_id");--> statement-breakpoint
CREATE INDEX "build_doc_sections_parent_section_id_idx" ON "build_doc_sections" USING btree ("parent_section_id");--> statement-breakpoint
CREATE INDEX "build_docs_server_id_idx" ON "build_docs" USING btree ("server_id");--> statement-breakpoint
CREATE UNIQUE INDEX "user_preferences_userId_feature_key_unique" ON "user_preferences" USING btree ("userId","feature_key");