...
const insertOSPatchVersionSchema = createInsertSchema(osPatchVersions)
const selectOSPatchVersionSchema = createSelectSchema(osPatchVersions)
const updateOSPatchVersionSchema = createUpdateSchema(osPatchVersions)
